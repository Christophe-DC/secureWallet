        ...
        SignPreloaderProxy(
            availableChains().map { chain ->
                when (chain) {
                    Chain.Doge,
                    Chain.Litecoin,
                    Chain.Bitcoin -> BitcoinSignerPreloader(chain, get())
                    ...
                    Chain.Mantle,
                    Chain.Celo,
                    Chain.Ethereum -> EvmSignerPreloader(chain, get())
        ...
        BroadcastProxy(
            availableChains().map { chain ->
                when (chain) {
                    Chain.Doge,
                    Chain.Litecoin,
                    Chain.Bitcoin -> BitcoinBroadcastClient(chain, get())
                    ...
                    Chain.Mantle,
                    Chain.Celo,
                    Chain.Ethereum -> EvmBroadcastClient(chain, get())
                    ...
                    Chain.Sei,
                    Chain.Noble,
                    Chain.Cosmos -> CosmosBroadcastClient(chain, get())
